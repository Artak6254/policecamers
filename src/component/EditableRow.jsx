    ...
    <tr key={data.id}>
      ...
      <td className="px-6 py-3 text-right">
        ...
        <button
          ...
          {isEditing && (
            <button
              className="mr-4 p-2 flex items-center rounded text-black text-sm tracking-wider border-2 border-green-600 relative"
              title="Update"
              onClick={onUpdate}
            >
              Update
